...
class MemberServiceTest {
	...
	void retriveMember_WhenMemberNotFound_ShouldThrowException() {
		...
		assertThatThrownBy(() -> memberService.retriveMember(99L)).isInstanceOf(MemberNotFoundException.class)
	...
	void increaseBookIssued_WhenExceedsMaxLimit_ShouldThrowException() {
		...
		assertThatThrownBy(() -> memberService.increaseBookIssued(1L, 4)).isInstanceOf(MaxNumOfIssuedBooksExceed.class)
	...
	void increaseBookIssued_WhenMemberNotFound_ShouldThrowException() {
		...
		assertThatThrownBy(() -> memberService.increaseBookIssued(99L, 1)).isInstanceOf(MemberNotFoundException.class);
	}
	...
	void decreaseBookIssued_WhenResultGoesNegative_ShouldThrowException() {
		...
		assertThatThrownBy(() -> memberService.decreaseBookIssued(1L, 3)).isInstanceOf(MinIssuedBooksExceed.class)
	...
	void decreaseBookIssued_WhenMemberNotFound_ShouldThrowException() {
		...
		assertThatThrownBy(() -> memberService.decreaseBookIssued(99L, 1)).isInstanceOf(MemberNotFoundException.class);
	}
	...
	void payBill_WhenInsufficientAmount_ShouldThrowException() {
		...
		assertThatThrownBy(() -> memberService.payBill(100.0, 10L)).isInstanceOf(InSufficientFundsException.class)
	...
	void payBill_WhenBillNotFound_ShouldThrowException() {
		...
		assertThatThrownBy(() -> memberService.payBill(500.0, 99L)).isInstanceOf(BillNotFoundException.class)
				.hasMessageContaining("99");
	}
}